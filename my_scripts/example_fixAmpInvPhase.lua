...
--time_step = linspace(0.01, 1.0, 20)
time_step = {0.01}
...
write_snapshot= "/home/adrian/UNIT_PNG/FastPM_new/output_tests/snaps/"       -- comment out to suppress snapshot output
-- 1d power spectrum (raw), without shotnoise correction
write_powerspectrum = "/home/adrian/UNIT_PNG/FastPM_new/output_tests/pks/"
