...
time_step = linspace(0.01, 0.5, 20)
--time_step = {0.01}

output_redshifts= {1.}  -- redshifts of output
...
write_snapshot= "/home/adrian/UNIT_PNG/FastPM_new/output_tests/snaps/N128_L250"       -- comment out to suppress snapshot output
-- 1d power spectrum (raw), without shotnoise correction
write_powerspectrum = "/home/adrian/UNIT_PNG/FastPM_new/output_tests/pks/N128_L250"
