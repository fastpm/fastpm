...
-- FoF halo catalogue
fof= "rungrowthexhaust/fof"                 -- base filename
linking_factor= 0.2        -- FoF linking length= linking_factor*mean_separation

-- Dark matter particle outputs (all particles)
snapshot= "rungrowthexhaust/snp"       -- comment out to suppress snapshot output

-- Dark matter particle subsample
-- subsample= "rungrowthexhaust/sub"           -- base filename
-- subsample_factor= 1/100    -- fraction of particles to output

-- Dark matter density grid
-- coarse_grid= "rungrowthexhaust/grid"        -- base filename
...
measure_power = "rungrowthexhaust/powerspec"
