...
-- FoF halo catalogue
fof= "runmanystepqpm1/fof"                 -- base filename
linking_factor= 0.2        -- FoF linking length= linking_factor*mean_separation

-- Dark matter particle outputs (all particles)
snapshot= "runmanystepqpm1/snp"       -- comment out to suppress snapshot output

-- Dark matter particle subsample
-- subsample= "runmanystepqpm1/sub"           -- base filename
-- subsample_factor= 1/100    -- fraction of particles to output

-- Dark matter density grid
-- coarse_grid= "runmanystepqpm1/grid"        -- base filename
...
measure_power = "runmanystepqpm1/powerspec"
