...
time_step = linspace(0.01,0.02,2)
--time_step = linspace(0.05,1.,40)
...
filename = string.format("srunE_SH%d_NS%d_every%d_proc%d_size%d_lvk%s_rcv%s_dtGADGET%s_pnf%d_B0", n_shell, n_side, every_ncdm, os.get_nprocs(), nc, lvk, remove_cosmic_variance, dealiasing_type, pm_nc_factor)
--loc = "/global/cscratch1/sd/abayer/fastpm/ncdm/Pncdm_init_test/"
loc = "/global/cscratch1/sd/abayer/trash/"
