-- parameter file for valgrind testing
-- Simple leak checks
--   valgrind --leak-check=full ../src/fastpm -T0 valgrind.lua
--
-- Run with gdb
--   valgrind --vgdb=yes --vgdb-errors=0 ../src/fastpm -T0 valgrind.lua
-- then in another terminal
--   gdb -ex "remote target | vgdb"
--
...
write_snapshot = "valgrind/fastpm"
write_fof = "valgrind/fof"
...
lc_write_usmesh = "valgrind/usmesh"
